...
const About = () => {
  ...
  return (
    <section className='flex py-20 px-[10svw] w-[100svw] justify-end items-start sm:items-center flex-col md:flex-row' id='about'>
      ...
      <div className='m-4'>
        <Image className={`rounded-full md:h-[240px] md:w-[240px] ss:w-[200px] ss:h-[200px] w-[180px] h-[180px]` } src={profile_picture} height={imgSize} width={imgSize} alt="profile_picture" />
      </div>
